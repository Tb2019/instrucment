...
payload = {'paperId': '873028.pdf'.partition('.')[0],
'pType': '1',
'device': 'PC'}
files=[
...
response = requests.request("POST", url, headers=headers, data=payload, files=files, proxies=pool.load_proxy(from_clash=False)[1])
